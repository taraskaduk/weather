...
# Wed Aug 22 21:35:06 2018 ------------------------------
# I've wrestled with this for a long time, and couldn't find a good way to assign stations to cities.
# One of my flaws is that I treat each MSA as a point, not a polygon.
# I now will try to do it the geospatial way, and God help me please
...
contains <- st_join(msa_sf, stations_sf) 
